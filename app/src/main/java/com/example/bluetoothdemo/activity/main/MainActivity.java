...
//                        Log.e(TAG, "accept: 定位权限"+aBoolean);
//                        if (aBoolean){

//                        }else {
//                            Toast.makeText(MainActivity.this,"开启定位权限才可以扫描",Toast.LENGTH_SHORT).show();
//                        }
//                    }
//                });
            }
...
//        searchJindDianDevice();
    ...
    private void initBluetoothDevices() {
        ...
        miscAdapter = new BluetoothDeviceAdapter(this, miscDevices, BluetoothDeviceAdapter.DEVICE_PHONE);
        computerAdapter = new BluetoothDeviceAdapter(this, computerDevices, BluetoothDeviceAdapter.DEVICE_PHONE);
        audioAdapter = new BluetoothDeviceAdapter(this, audioDevices, BluetoothDeviceAdapter.DEVICE_PHONE);
        unknowAdapter = new BluetoothDeviceAdapter(this, unknowDevices, BluetoothDeviceAdapter.DEVICE_PHONE);
